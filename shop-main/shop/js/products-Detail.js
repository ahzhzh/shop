...
"vga6": {
    ...
    "image": "./img/vga6.png",
    "specs": [
        { "항목": "모델명", "세부사항": "지포스 RTX 5080 MIRACLE WHITE D7 16GB" },
        { "항목": "칩셋", "세부사항": "RTX 5080" },
        ...
        { "항목": "출력 단자", "세부사항": "HDMI2.1, DP2.1" },
        { "항목": "사용 전력", "세부사항": "360W" },
        { "항목": "쿨링 시스템", "세부사항": "3팬 / 두께 62mm / 제로팬(0-dB기술)" },
        { "항목": "특수 기능", "세부사항": "백플레이트 / DrMOS / LED 라이트" },
        { "항목": "구성품", "세부사항": "VGA지지대, 3x8핀 to 16핀 커넥터" },
        { "항목": "A/S 보증 기간", "세부사항": "3년" }
    ]
},
...
"vga29": {
    ...
    image: "./img/vga29.png",
    specs: [
        { 항목: "모델명", 세부사항: "ZOTAC GAMING 지포스 RTX 5070 AMP White D7 12GB" },
        { 항목: "칩셋", 세부사항: "NVIDIA RTX 5070" },
        { 항목: "인터페이스", 세부사항: "PCIe5.0x16" },
        { 항목: "권장 파워 용량", 세부사항: "정격파워 650W 이상" },
        { 항목: "전원 포트", 세부사항: "16핀(12V2x6) x1" },
        { 항목: "가로(길이)", 세부사항: "304.4mm" },
        { 항목: "베이스클럭", 세부사항: "2325MHz" },
        { 항목: "부스트클럭", 세부사항: "2587MHz" },
        { 항목: "스트림 프로세서", 세부사항: "6144개" },
        { 항목: "메모리 종류", 세부사항: "GDDR7" },
        ...
        { 항목: "사용 전력", 세부사항: "250W" },
        { 항목: "전원부", 세부사항: "9+3페이즈" },
        { 항목: "쿨링 방식 및 팬 개수", 세부사항: "3팬, 두께 41.6mm, 제로팬(0-dB기술), 백플레이트, SPECTRA" },
        { 항목: "구성품", 세부사항: "VGA지지대, 2x8핀 to 16핀 커넥터" },
        { 항목: "A/S 보증 기간", 세부사항: "3년" }
    ]
},
